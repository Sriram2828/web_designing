...
<body>
    <form action="index.php" method="post">
        <div class="Details">
            ...
            <input type="text" placeholder="12-digit register number" name="regno"  required>
            <br>

            <label for="phno">phone number:</label>
            <input type="text" placeholder="10-digit mobile number" name="phno" required>
            <br>
        
            <label for="email">Email:</label>
            <input type="email" placeholder="xxx...@gmail.com" name="email"  required>
            <br>
            ...
            <input type="password" placeholder="Retype your password" name="confpwd"  required>
            <br>
